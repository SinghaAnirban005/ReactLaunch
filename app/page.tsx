...
import { Rocket, Zap, Code, Globe, ArrowRight, CheckCircle, Star, Github, Play } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Deploy your React apps in seconds with our optimized build pipeline"
    },
    {
      icon: <Globe className="w-6 h-6" />,
      title: "Global CDN",
      description: "Instant worldwide distribution with edge caching for maximum performance"
    },
    {
      icon: <Code className="w-6 h-6" />,
      title: "Zero Config",
      description: "Just push your code. We handle the rest with intelligent auto-detection"
    }
  ];

  const testimonials = [
    { name: "Sarah Chen", role: "Frontend Developer", text: "Deployment has never been this smooth. Love it!" },
    { name: "Marcus Rodriguez", role: "Tech Lead", text: "Our team productivity increased by 40% after switching." },
    { name: "Emily Watson", role: "Indie Hacker", text: "Perfect for rapid prototyping and testing ideas." }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      <nav className="relative z-10 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button className="bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 px-4 py-2 rounded-lg transition-all duration-300 transform hover:scale-105" onClick={() => router.push('/auth/login')}>
              Get Started
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              The fastest way to deploy your static React applications. Start Dep
              Zero configuration, infinite possibilities.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <button className="group bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 transform hover:scale-105 flex items-center space-x-2" onClick={() => router.push('/auth/register')}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
              Why Choose ReactDeploy?
            </h2>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Built by developers, for developers. Experience the future of React deployment.
            </p>
          </div>
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: "01", title: "Connect Repository", code: "git clone your-repo" },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-gradient-to-b from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-purple-500/20 to-cyan-500/20 backdrop-blur-sm rounded-3xl p-12 border border-purple-500/30">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join thousands of developers who trust ReactDeploy for their projects.
            </p>
      ...
      <footer className="relative z-10 px-6 py-12 border-t border-slate-800">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8 pt-8 border-t border-slate-800 text-center text-gray-400">
            <p>© 2025 ReactDeploy. Built with ❤️ for the React community.</p>
          </div>
        </div>
      </footer>
    </div>
